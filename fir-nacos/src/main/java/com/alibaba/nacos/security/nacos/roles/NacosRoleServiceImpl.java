...
/**
 * Nacos builtin role io.github.huafoog.fir.service.
 *
 * @author nkorange
 * @since 1.2.0
 */
...
public class NacosRoleServiceImpl {
	...
	/**
	 * Determine if the user has permission of the io.github.huafoog.fir.resource.
	 *
	 * <p>
	...
	public boolean hasPermission(String username, Permission permission) {
		...
		// Old global admin can pass io.github.huafoog.fir.resource 'console/':
	 ...
	 * Add permission.
	 * @param role role name
	 * @param resource io.github.huafoog.fir.resource
	 * @param action action
	 */
